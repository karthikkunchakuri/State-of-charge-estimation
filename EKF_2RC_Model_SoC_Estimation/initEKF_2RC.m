function ekfData = initEKF_2RC(v0,T0,SigmaX0,SigmaV,SigmaW,model)

  % Initial state description
  ir1   = 0;                           ekfData.irInd1 = 1;
  ir2   = 0;                           ekfData.irInd2 = 2;
  SOC0  = mean(SOCfromOCVtemp(v0,T0,model)); ekfData.zkInd = 3;
  ekfData.xhat  = [ir1 ir2 SOC0]'; % initial state
