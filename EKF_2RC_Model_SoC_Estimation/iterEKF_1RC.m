function [zkbar,zkbarbnd,dzk,dzkbnd,ekfData] = iterEKF_1RC(vk,ik,Tk,deltat,ekfData)
model = ekfData.model;
...
yhat = OCVfromSOCtemp(xhat(zkInd),Tk,model) - R1*xhat(irInd1) - R0*ik;
