function spkfData = initSPKF_ESC(v0, T0, SigmaX0, SigmaV, SigmaW, model)
  % First, initialize the variables for the "bar" filter
  % Initial state description
  ir1 = 0; spkfData.irInd1 = 1;
  ir2 = 0; spkfData.irInd2 = 2; 
  hk0 = 0; spkfData.hkInd = 3;
  SOC0 = mean(SOCfromOCVtemp(v0, T0, model)); spkfData.zkInd = 4;
  ib0 = 0; spkfData.biasInd = 5;                                           % Add state to estimate current sensor bias
  spkfData.xhat = [ir1 ir2 hk0 SOC0 ib0]';                                 % initial state
